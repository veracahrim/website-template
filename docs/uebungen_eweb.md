...
Ergänzen Sie das die HTML Datei mit einer grundlegenden Struktur mit folgenden Punkten:
...
einsetzen können. Schauen Sie darauf, dass Sie allfälligen Künstler*innen und/oder Fotograf*innen Anerkennung zuteil
werden lassen.
...
Um Farben aus Bildern zu erhalten gibt es Zahlreiche Methoden, die einfachste ist wahrscheinlich die Pipettenfunktion in
...
Gradient auf dem Bild hat, dann denselben Gradienten als Hintergrundfarbe bei unserem Conten bereich definieren, und am
...
Öffnen Sie die Entwichlertools in Ihrem Browser-of-choice und stellen Sie den Viewport auf Mobile ein. Hier können Sie
...
Mobile-Friendly Websiten an und entscheiden Sie sich für eine Lösung, die Ihnen entspricht und implementieren Sie diese.


## Aufgabe 6

Fügen Sie ein Paar Icons beim Navigations Bar ein. Sie haben ein paar Beispiel-Icons im Assets ordner bereitgestellt.
...
Suchen Sie passende Icons für ihre Hobbies und stellen Sie die Hobbies inkl. Icons dar.
...
Unterteilen Sie die Inhalte der von styles.css in weitere Dateien:
...
Mithilfe von CSS, entfernen Sie das Standardstyling der einzelnen Komponenten und fügen Sie ihr eigenes Design hinzu.

Wichtig ist, dass die Inputfelder die momentan aktiv sind, sich nach wie vor von den Inaktiven unterscheiden.

## Aufgabe 11

Ein grosser Bestandteil eines Web-Entwicklers ist die Online Recherche für das Lösen von Problemen die man selber
eventuell noch nicht zu lösen weiss.

Für den Protfolio bereich unserer Webseite wollen wir einen interessanten CSS Effekt einsetzen. Wir wollen eine Art
...
- Generell:
    ...
    - Nicht alles obereinander wie bei der Mobile ansicht, wir haben nun mehr Platz.
...
- Portfolio
    - Grösse anpassen
- Kontakt
    - Eingabefelder für Name und E-mail Adresse nun nebeneinaner.
